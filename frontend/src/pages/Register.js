...
function Register() {
  ...
  const countryCodes = [
    ...
    { code: '+672', country: 'Antarctica / Norfolk Island', flag: '🇦🇶' },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('/api/auth/register', { name, email, phone: fullPhone, password });
          ...
          <div>
            ...
            <div className="relative mb-3">
              <select
                ...
                className="w-full pl-3 pr-10 py-3 rounded-lg bg-white border border-gray-200 text-dark-text focus:border-accent-purple focus:outline-none transition-colors appearance-none cursor-pointer text-sm"
              >
                {countryCodes.map((cc) => (
            ...
            <p className="mt-1 text-xs text-dark-muted">Enter your phone number without the country code</p>
          </div>
